    ...
    return [
        ...
        ArtifactInfo(
            ...
            commands=[
                ...
                "  --time-window-offset 192 --time-window-offset 256",
                "",
                "# Generate the overlay histogram figure (reads Shin bundles and Macé CSV from other artifacts):",
                "PYTHONPATH=. python scripts/telemetry_regime_compare_fig.py \\",
                "  --out-png figs/paper/telemetry_regime_compare.png",
            ],
            notes="Overlays PfPeakFrac(flow), guard_q90, and iqr_alias_bg across Brain-* simulations, Shin real IQ, and Macé PD-only planes; intended as telemetry anchoring (not a claim that sims match real data).",
        ),
        ArtifactInfo(

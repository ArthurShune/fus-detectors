...
def _render_appendix_tex(manifest: dict[str, Any], *, out_path: Path) -> None:
    ...
    lines.append("\\section{Repository Reproducibility Manifest}")
...
def _default_artifacts() -> list[ArtifactInfo]:
    return [
        ...
        ArtifactInfo(
            ...
            paper_refs=["Twinkling section: Figure (structural evaluation masks)", "Figure: twinkling_gammex_along_mask_overlay.png"],
            outputs=[
        ...
        ArtifactInfo(
            ...
            paper_refs=["Twinkling section: Figure (structural evaluation masks)", "Figure: twinkling_gammex_across_mask_overlay.png"],
            outputs=[
        ...
        ArtifactInfo(
            ...
            outputs=[
                ...
                "runs/real/twinkling_gammex_across17_prf2500_str4_whitened_power/",

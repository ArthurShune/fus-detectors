...
def _build_family_table(payload: dict[str, Any]) -> str:
    ...
    if pd_p is not None:
        pd_p_text = (
            f" Against baseline power Doppler, the block-mean AUC difference for the fully "
            f"whitened variant gives an exact paired sign-flip test p-value of {pd_p:.5f}."
        )
    lines: list[str] = []
    lines.append("% AUTO-GENERATED by scripts/ulm7883227_pala_support_tables.py; DO NOT EDIT BY HAND.")

...
A plain-language glossary for the appendix labels appears first in Appendix~\ref{app:appendix-guide}, and the main-text method overview is shown in Figure~\ref{fig:stap_pipeline}. This appendix then states the formal preconditions under which the optional shrink-only regularizer is allowed to modify scores; if any precondition fails, the layer is disabled ($w\equiv 1$).

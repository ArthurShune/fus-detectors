...
\hline
\end{tabular}
\caption{Literature-grounded stress axes used in the held-out reduced-grid SIMUS frontier audit. These perturbations are intended to approximate clinically relevant nuisance pressure, not to claim one-to-one replay of any single in vivo acquisition.}

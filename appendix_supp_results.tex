...
\begin{itemize}[nosep]
  ...
  \item \textbf{Detector-family policy summaries:} the compact detector-family policy table and baseline-family summary (Table~\ref{tab:detector_family_policy} and Table~\ref{tab:brain_baseline_summary}).
\end{itemize}

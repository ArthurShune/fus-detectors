...
\begin{itemize}[nosep]
  ...
  \item SIMUS/PyMUST structural/functional checkpoint and compact real-data translation audit: Tables~\ref{tab:simus_v2_structural_latency} and \ref{tab:simus_v2_functional_latency}, plus the supplement-only real-IQ same-residual audit table later in this appendix.
  ...
  \item Compact detector-family policy summary: Table~\ref{tab:detector_family_policy}.

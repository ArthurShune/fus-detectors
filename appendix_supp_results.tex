...
\begin{itemize}[nosep]
  ...
  \item Accepted SIMUS-ClinUtility-v2 structural/functional latency-vs-performance checkpoint: Tables~\ref{tab:simus_v2_structural_latency} and \ref{tab:simus_v2_functional_latency}.
\end{itemize}

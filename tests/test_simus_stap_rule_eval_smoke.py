...
def test_simus_stap_rule_eval_smoke(tmp_path):
    ...
    rows = [
        ...
        },
        {
            ...
            "motion_disp_rms_px": "1.2",
            "auc_main_vs_bg": "0.67",
            "auc_main_vs_nuisance": "0.46",
            "fpr_nuisance_match@0p5": "0.53",
            "delta_auc_main_vs_bg": "0.07",
            "delta_auc_main_vs_nuisance": "0.41",
            "delta_fpr_nuisance_match@0p5": "-0.47",
        },
        {
            "case_key": "b",
        ...
        },
        {
            ...
            "motion_disp_rms_px": "2.6",
            "auc_main_vs_bg": "0.54",
            "auc_main_vs_nuisance": "0.54",
            "fpr_nuisance_match@0p5": "0.42",
            "delta_auc_main_vs_bg": "0.14",
            "delta_auc_main_vs_nuisance": "0.52",
            "delta_fpr_nuisance_match@0p5": "-0.58",
        },
    ]
    ...
    assert "motion_disp_rms_robust_midrobust" in payload["summary_by_rule"]

...
A plain-language glossary for the appendix labels appears first in Appendix~\ref{app:appendix-guide}. This appendix then states the formal preconditions under which the optional shrink-only penalty layer is allowed to modify scores; if any precondition fails, the layer is disabled ($w\equiv 1$).
